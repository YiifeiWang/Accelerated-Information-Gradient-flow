...
WAIG.name = 'W-AIG';
WAIG.Pname = 'W-AIG';
WAIG.opts = struct('tau',1e-6,'iter_num',6e3,'record',1,'trace',1,'ibw',-1,'ktype',1,...
	'itPrint',1e2,'X_test',X_test,'y_test',y_test,'tau_itv', 1e2, 'tau_dec',0.9, 'restart',1,'strong',0,'ttype',1);

KWGF.name = 'KW-GF';
KWGF.Pname = 'KW-GF';
KWGF.opts = struct('tau',1e-7,'iter_num',6e3,'record',1,'trace',1,'ibw',-1,'ktype',1,...
	'itPrint',1e2,'X_test',X_test,'y_test',y_test,'tau_itv', 1e2, 'tau_dec',0.9,'ttype',1,'lbd',1);

KWAIG.name = 'KW-AIG';
KWAIG.Pname = 'KW-AIG';
KWAIG.opts = struct('tau',1e-8,'iter_num',6e3,'record',1,'trace',1,'ibw',-1,'ktype',1,...
